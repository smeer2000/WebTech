var artikelnew = document.getElementById('artikelneu');
if (artikelnew !== null) {

    artikelnew.addEventListener('submit', e => {


        let failcounter = checkInputs();
...
function checkInputs() {
    ...
    if (artikel === "" || artikel === null) {
        setErrorFor(msgArtikel, 'Bitte Artikel Namen angeben. ' + " <i class=\"bi bi-x-octagon-fill\"></i>");
        failcounter.push("1");
